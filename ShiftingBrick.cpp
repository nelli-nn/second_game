...
ShiftingBrick::ShiftingBrick(sf::Vector2f position)
{
...
void ShiftingBrick::Create(std::shared_ptr< Paddle> paddle, std::shared_ptr<Ball> ball, std::shared_ptr<Field> field)
{
	field->CreateShiftingBrick();
}