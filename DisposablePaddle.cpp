...
DisposablePaddle::DisposablePaddle(sf::Vector2f position)
{
...
void DisposablePaddle::Create(std::shared_ptr< Paddle> paddle, std::shared_ptr<Ball> ball, std::shared_ptr<Field> field)
{
	ball->SetDisposablePaddle(true);
}